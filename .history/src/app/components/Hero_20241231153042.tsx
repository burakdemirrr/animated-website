    ...
    >
      ...
      <div className="container">
        <div className="max-w-4xl">
          <ParallaxSection offset={100} speed={1.5} direction="up">
            <motion.h1
          ...
          <ParallaxSection offset={80} speed={1.2} direction="up">
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <ParallaxSection offset={60} speed={1} direction="up">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      {/* Floating Elements */}
      <ParallaxSection offset={120} speed={2} direction="right">
        <motion.div
      ...
      <ParallaxSection offset={120} speed={2} direction="left">
        <motion.div
